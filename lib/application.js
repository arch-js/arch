(function(){
  var bluebird, cursor, dom, routes, serverRendering, cookie, domUtils, ref$, keys, each, Obj, map, span, appComponent, initAppState, observePageChange;
  ...
  ref$ = require('prelude-ls'), keys = ref$.keys, each = ref$.each, Obj = ref$.Obj, map = ref$.map;
  span = dom.span;
