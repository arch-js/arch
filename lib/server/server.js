(function(){
  var express, path, bluebird, bodyParser, bundler, livescript, register, defaultConfig, renderBody, ref$, each, values, filter, find, flatten, map, first, archGet, archPost, __template;
