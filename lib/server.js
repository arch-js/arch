(function(){
  var express, fs, path, jade, react, bluebird, bundler, LiveScript, ref$, each, values, filter, find, flatten, map, first, __template, readFile, defaults, reflexInterp, reflexRender;
